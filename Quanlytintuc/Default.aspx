...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <br />
    <div data-v-1dfae8b7="" class="magic">
        <h1 data-v-1dfae8b7="">Tôi là Tiến Đạt Magic</h1>
    </div>

    <div class="container-fluid">
        <b>Trang quản trị viên </b>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:tintucConnectionString %>" SelectCommand="SELECT * FROM [TINTUC]"></asp:SqlDataSource>
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:tintucConnectionString %>" SelectCommand="SELECT * FROM [TACGIA]"></asp:SqlDataSource>
