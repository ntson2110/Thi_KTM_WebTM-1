$(document).ready(function () {
    $("#ContentPlaceHolder1_GridView1 tr:even").css("backgroundColor", "#F8E0F1");
    $("#ContentPlaceHolder1_GridView2 tr:even").css("backgroundColor", "#F8E0F1");
    $("#ContentPlaceHolder1_GridView3 tr:even").css("backgroundColor", "#F8E0F1");

    $("#ContentPlaceHolder1_DetailsView1 tr:even").css("backgroundColor", "#F8E0F1");
    $("#ContentPlaceHolder1_DetailsView2 tr:even").css("backgroundColor", "#F8E0F1");
    $("#ContentPlaceHolder1_DetailsView3 tr:even").css("backgroundColor", "#F8E0F1");
